...
public class Custom {
	...
	public interface PotionRecipe {
		void register( Supplier< ? extends Potion > input, Supplier< ? extends Item > item, Supplier< ? extends Potion > output );
	}
	...
	public interface SpawnPlacements {
		< Type extends Mob > void register( EntityType< Type > entityType, net.minecraft.world.entity.SpawnPlacementType type, Heightmap.Types heightmap,
