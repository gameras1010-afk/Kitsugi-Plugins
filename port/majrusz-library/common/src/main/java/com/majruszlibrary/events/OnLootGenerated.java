...
public class OnLootGenerated implements IEntityEvent {
	...
	public OnLootGenerated( ObjectArrayList< ItemStack > generatedLoot, @Nullable ResourceLocation lootId, LootContext context ) {
		...
		this.lootId = lootId != null ? lootId : ResourceLocation.parse( "empty" );
		...
		this.killer = this.getParameter( LootContextParams.ATTACKING_ENTITY );
