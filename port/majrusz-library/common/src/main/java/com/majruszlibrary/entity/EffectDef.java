...
public class EffectDef {
	...
	static {
		Serializables.get( EffectDef.class )
			.define( "id", Reader.optional( Reader.mobEffect() ), s->s.effect.get(), ( s, v )->s.effect = ()->v )
	...
	public MobEffectInstance toEffectInstance() {
		return new MobEffectInstance( BuiltInRegistries.MOB_EFFECT.wrapAsHolder( this.effect.get() ), TimeHelper.toTicks( this.duration ), this.amplifier );
	}
