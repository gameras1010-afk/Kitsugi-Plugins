...
public class WorldData {
	...
	private void setup( OnLevelsLoaded data ) {
		...
		data.server.overworld()
			.getDataStorage()
			.computeIfAbsent( new SavedData.Factory<>( ()->this.savedData, this.savedData::load, DataFixTypes.LEVEL ), this.name );
	}
	...
	private static class SavedData extends net.minecraft.world.level.saveddata.SavedData {
		...
		public SavedData load( CompoundTag tag, HolderLookup.Provider provider ) {
