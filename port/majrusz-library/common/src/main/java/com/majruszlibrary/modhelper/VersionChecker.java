...
class VersionChecker {
	...
	private void findAvailableUpdates() {
		...
		MutableComponent versions = TextHelper.translatable( "majruszlibrary.update_versions", name, this.currentVersion )
	...
	private static void sendUpdateMessages( OnPlayerLoggedIn data ) {
		data.player.sendSystemMessage( TextHelper.translatable( "majruszlibrary.update_available" ) );
